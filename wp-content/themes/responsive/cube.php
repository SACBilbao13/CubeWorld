...
void setup(){
	size(640,480);
	startBg = loadImage("<?php bloginfo('siteurl'); ?>/wp-includes/images/games/cube/intro.jpg");
	gameBg = loadImage("<?php bloginfo('siteurl'); ?>/wp-includes/images/games/cube/background_win.jpg");
	loseBg = loadImage("<?php bloginfo('siteurl'); ?>/wp-includes/images/games/cube/background_fail.jpg");
	win = loadImage("<?php bloginfo('siteurl'); ?>/wp-includes/images/games/cube/congratulations.png");
	lose = loadImage("<?php bloginfo('siteurl'); ?>/wp-includes/images/games/cube/fail.png");
	ignition1 = loadImage("<?php bloginfo('siteurl'); ?>/wp-includes/images/games/cube/ignition_normal.png");
	ignition2 = loadImage("<?php bloginfo('siteurl'); ?>/wp-includes/images/games/cube/ignition_high.png");
	playAgain1 = loadImage("<?php bloginfo('siteurl'); ?>/wp-includes/images/games/cube/play_again_normal.png");
	playAgain2 = loadImage("<?php bloginfo('siteurl'); ?>/wp-includes/images/games/cube/play_again_high.png");
	plat = loadImage("<?php bloginfo('siteurl'); ?>/wp-includes/images/games/cube/base.png");
	cubeSat = loadImage("<?php bloginfo('siteurl'); ?>/wp-includes/images/games/cube/cube.png");
	fireCube= loadImage("<?php bloginfo('siteurl'); ?>/wp-includes/images/games/cube/fire_cube.png");
